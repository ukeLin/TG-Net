...
% ResultMapPath = 'D:\usingproject\MFSNet-main\test\HAM10000\';
ResultMapPath = 'D:\usingproject\MFSNet-main\test\Kvasir';
Models = {''}; %Models = {'UNet','UNet++','SFA'}; 
modelNum = length(Models);

% ---- 2. Ground-truth Datasets Setting ----
DataPath = ResultMapPath;
Datasets = {''}; %Datasets = {'CVC-ClinicDB', 'CVC-ColonDB','ETIS-LaribPolypDB', 'Kvasir','CVC-300'}; 
...
for d = 1:datasetNum
    ...
    for m = 1:modelNum
        ...
        resMapPath = [ResultMapPath model '/outputs_next_v2/' ];
...
%             resmap = reshape(mapminmax(resmap(:)',1,0),size(resmap));
        ...
        save(['res_test.mat' model],'Sm', 'mae', 'column_Dic', 'column_Sen', 'column_Spe', 'column_E','column_IoU','maxDic','maxEm','maxSen','maxSpe','maxIoU','meanIoU','meanDic','meanEm','meanSen','meanSpe');
